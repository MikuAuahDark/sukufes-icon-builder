...
-- skin path
local dir = (...):sub(0, -6)
local path = string.sub(..., 1, string.len(...) - string.len(".skins.Snap.skin"))
...
skin.controls.button_body_nohover_color             = bodycolor:darken(7)
...
skin.controls.checkbox_check_color                  = pinkcolor
skin.controls.checkbox_text_font                    = smallfont

-- closebutton
skin.controls.closebutton_body_nohover_color        = pinkcolor
skin.controls.closebutton_body_down_color           = pinkcolor:darken(5)
skin.controls.closebutton_body_hover_color          = pinkcolor:lighten(5)
...
skin.controls.slider_value_color                    = pinkcolor
...
-- multichoice
skin.controls.multichoice_body_nohover_color        = bodycolor:darken(7)
...
skin.controls.multichoicerow_body_hover_color       = pinkcolor
skin.controls.multichoicerow_text_nohover_color     = textcolor
skin.controls.multichoicerow_text_hover_color       = whitecolor
skin.controls.multichoicerow_text_font              = smallfont

-- textinput
skin.controls.textinput_body_color                  = bodycolor:darken(7)
...
skin.controls.progressbar_bar_color                 = pinkcolor
